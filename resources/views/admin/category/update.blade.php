                        ...
                        <form action="{{url('category-update'.'/'.$category->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="user_id" value="1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="category_name" id="category_name" placeholder="Enter Product Name" value="{{$category->category_name}}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input  type="text" class="form-control" name="category_desc" id="category_desc" placeholder="Enter Product Category" value="{{$category->category_desc}}" >
                            ...
                            <div class="form-group">
                                <div>
                                <img src="{{asset('/backend/category/'.$category->category_image)}}" alt="image" 
