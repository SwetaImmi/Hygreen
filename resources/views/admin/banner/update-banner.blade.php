                        ...
                        <form action="{{url('banner-update'.'/'.$banner->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title" placeholder="Enter Banner Name" value="{{$banner->title}}">
                                    <span> @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description" placeholder="Enter Banner Discription" value="{{$banner->description}}">
                                ...
                                <div class="form-group">
                                    <div>
                                    <img name="banner_image" src="{{asset('/backend/Banner/'.$banner->image)}}" alt="image" style="width: 50px;    height: 50px;    border-radius: 20%" />
